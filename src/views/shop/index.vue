      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="修改时间">
            <el-input v-model="form.modifiedAt" style="width: 370px;" />
          </el-form-item>
...
const defaultForm = { id: null, username: null, password: null, createdAt: null, modifiedAt: null, telephone: null }
export default {
  name: 'MyshopUser',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '用户管理表', url: 'api/myshopUser', idField: 'id', sort: 'id,desc', crudMethod: { ...crudMyshopUser }})
  },
  data() {
    return {
      permission: {
